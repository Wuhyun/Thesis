...
%DIF DEL Thesis_before_viva/flattened.tex   Wed May 18 11:56:46 2022
%DIF ADD thesis/flattened.tex               Wed May 18 16:07:52 2022
...
\DIFdelbegin \DIFdel{And }\DIFdelend \DIFaddbegin \DIFadd{If this thesis was to be shared between everyone who made it happen, my share would be about a page. }\DIFaddend I would like to \DIFdelbegin \DIFdel{acknowledge .
..
}\DIFdelend \DIFaddbegin \DIFadd{use this page to thank them and apologise to those who were not mentioned.
}\DIFaddend 

\DIFaddbegin \DIFadd{I would first like to thank my supervisors, James Fergusson and Paul Shellard. James has been the most patient and considerate supervisor one can ever hope for and was always there to give me valuable advice whenever I needed it. I am lucky to have been introduced to cosmology by him and benefit from his scientific intuition on many subjects. I am grateful to  Paul for his insightful comments throughout my studies and for running our department. I would like to thank Kacper Kornet for his technical support; he is the reason why my code could run at all. I also express my gratitude to Trinity College for creating such an inspiring environment to study and for providing financial support during my postgraduate studies.
}
...
The galaxies we observe today are in fact their images from \DIFdelbegin \DIFdel{more than }\DIFdelend \DIFaddbegin \DIFadd{tens of }\DIFaddend thousands of years ago. \DIFdelbegin \DIFdel{Since }\DIFdelend \DIFaddbegin \DIFadd{This is due to }\DIFaddend the speed of light \DIFdelbegin \DIFdel{is limited, we see the universe further back in time the farther away we look. To what extent can we do this?Can we have a glimpse of the universe from, say, 13.8 billion years ago?
}\DIFdelend \DIFaddbegin \DIFadd{being finite, so the more distant an object is from us, the older the image we observe. This raises the question ``how far back can we see?''
}\DIFaddend 

The radio astronomers Arno Penzias and Robert Wilson were calibrating their 50-foot-long horn antenna in 1964 when they found a mysterious background noise \DIFaddbegin \cite{Penzias1965}\DIFaddend . The measurements were independent of time and location in the sky and persisted after the removal of various potential contaminants. After the theoretical work of Robert Dicke, Jim Peebles, and David Wilkinson was brought forward\DIFdelbegin %DIFDELCMD < \cite{Dicke1965}%%%
\DIFdelend , Penzias and Wilson identified the noise as Cosmic Microwave Background (CMB) radiation: ancient light from the early universe reaching us after billions of years \DIFdelbegin %DIFDELCMD < \cite{Penzias1965}%%%
\DIFdelend \DIFaddbegin \cite{Penzias1965,Dicke1965}\DIFaddend . The discovery provided us with one of the most valuable probes of the physical universe. 

Our modern mathematical formulation of cosmology is built on Einstein's work on general relativity in \DIFdelbegin \DIFdel{1915. }\DIFdelend \DIFaddbegin \DIFadd{1915 }\cite{Einstein1915fieldequations}\DIFadd{. }\DIFaddend Using his framework, Friedmann, Lemaître, Robertson, and Walker contributed to writing down the unique metric for a spatially homogeneous and isotropic universe \DIFaddbegin \cite{Friedman1922flrw1,Friedmann1924flrw2,Lemaitre1927flrw,Robertson1935flrw,Walker1937flrw}\DIFaddend .  It was then realised that this FLRW metric has no stable static solution, and the universe likely started from a Big Bang and has been continuously expanding since. This was supported by Edwin Hubble's measurements of Cepheid variables in 1929 \DIFaddbegin \cite{Hubble1929} \DIFaddend and confirmed by the aforementioned discovery of the CMB, which was one of the key predictions of the Big Bang cosmology.

The Big Bang theory by itself, however, could not explain the apparent uniformity of the CMB in the early universe\DIFaddbegin \DIFadd{, as well as the flatness of the universe and the lack of magnetic monopoles today}\DIFaddend . The theory of cosmic inflation emerged to address \DIFdelbegin \DIFdel{this problem}\DIFdelend \DIFaddbegin \DIFadd{these problems}\DIFaddend ; the universe undergoes a phase of accelerated expansion shortly after the Big Bang \DIFaddbegin \cite{Guth1981inflation}\DIFaddend . Inflation successfully resolved the problem and further provided a mechanism for generating the initial density fluctuations which grow into the structure in the universe we observe today. These primordial fluctuations originate from quantum \DIFdelbegin \DIFdel{fluctuation }\DIFdelend \DIFaddbegin \DIFadd{fluctuations }\DIFaddend of the inflaton which has \DIFdelbegin \DIFdel{near }\DIFdelend \DIFaddbegin \DIFadd{a nearly }\DIFaddend scale-invariant spectrum. This \DIFdelbegin \DIFdel{has been }\DIFdelend \DIFaddbegin \DIFadd{was }\DIFaddend confirmed when the Cosmic Background Explorer (COBE) discovered small anisotropies within the CMB in 1992 consistent with the inflationary predictions \DIFaddbegin \cite{Smoot1992cobe}\DIFaddend .
...
Primordial non-Gaussianity is a key statistic for studying \DIFaddbegin \DIFadd{the }\DIFaddend physics of the early universe \DIFaddbegin \cite{Chen2010review,Komatsu2010}\DIFaddend . The theory of inflation has been successful in describing the observed data, but its exact mechanism is yet undetermined. Currently\DIFaddbegin \DIFadd{, }\DIFaddend there are numerous viable inflationary models with well-founded physical motivations. Non-Gaussian signatures of primordial fluctuations are robust predictions of various models, and measuring their shape and amplitude allows us to constrain particular inflationary scenarios. CMB bispectrum analysis from Planck yielded the most precise measurements of primordial non-Gaussianity to date \DIFaddbegin \cite{PlanckCollaboration2018}\DIFaddend . So far, no statistically significant amount of non-Gaussianity has been detected.

In the near future, we expect several new major CMB experiments. The Simons Observatory (SO) \cite{TheSimonsObservatoryCollaboration2018} is a ground-based experiment currently under construction in the Atacama Desert of Chile. SO is expected to measure both CMB temperature and polarisation to unprecedented precision, largely improved compared to Planck. The first light from SO is planned to be observed in early 2022. Many more \DIFaddbegin \DIFadd{next-generation experiments such as }\DIFaddend CMB Stage-4 (CMB-S4) \DIFdelbegin \DIFdel{experiments are proposed, brightening future }\DIFdelend \DIFaddbegin \cite{Abazajian2016,Abazajian2019} \DIFadd{and LiteBIRD }\cite{Hazumi2019litebird} \DIFadd{are due course, brightening }\DIFaddend prospects for CMB science. In particular, the upcoming measurements will allow us to \DIFaddbegin \DIFadd{further }\DIFaddend constrain primordial non-Gaussianity\DIFdelbegin \DIFdel{further}\DIFdelend , providing discovery potential \DIFaddbegin \cite{Meerburg2019}\DIFaddend .
...
This chapter provides mathematical background and some physical intuitions for studying the CMB anisotropy\DIFaddbegin \DIFadd{, based on some standard materials on the topic including }\cite{Dodelson2003textbook,Fergusson2020cosmology,Challinor2009lecture}\DIFaddend . We start by \DIFdelbegin \DIFdel{making }\DIFdelend \DIFaddbegin \DIFadd{taking }\DIFaddend a step forward from the homogeneous and isotropic universe discussed in the previous chapter and formulate the cosmological perturbation theory in Section \ref{section:the_inhomogeneous_universe}. Focussing on scalar perturbations we derive the linearised equations governing the time evolution of the perturbative variables in Section \ref{section:linearised_equations}. In Section \ref{section:CMB_anisotropy} we introduce the Boltzmann equation for photons and outline how \DIFdelbegin \DIFdel{they are }\DIFdelend \DIFaddbegin \DIFadd{it is }\DIFaddend solved numerically. We connect the primordial power spectrum to the angular power spectrum of the CMB anisotropy measured today.
...
%DIFDELCMD < %%%
\DIFdel{where we used a bar to distinguish the `background' quantities computed in the homogeneous universe. We now perturbed }\DIFdelend \DIFaddbegin \DIFadd{.
}}
\DIFadd{We now perturb }\DIFaddend the metric as follows.
\begin{align}
	ds^2 = \DIFdelbegin %DIFDELCMD < \bar{a}%%%
...
\DIFdelbegin %DIFDELCMD < \end{align}
%DIFDELCMD < %%%
\DIFdel{This allows us to do }\DIFdelend \DIFaddbegin }
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{pmatrix} \frac{1}{\sqrt{C_l^{TT}}} & 0  \\ \frac{- C_l^{TE}}{\sqrt{C_l^{TT}} \sqrt{C_l^{TT} C_l^{EE} - C_l^{TE^2}}}  &  \frac{ C_l^{TT}}{\sqrt{C_l^{TT}} \sqrt{C_l^{TT} C_l^{EE} - C_l^{TE^2}}} \end{pmatrix}
...
\DIFdelbegin \DIFdel{First, we }\DIFdelend \DIFaddbegin \DIFadd{The main difference between }\textsc{\DIFadd{CMB-BEst}} \DIFadd{and the conventional Modal estimator }\cite{Fergusson2010general} \DIFadd{is that }\textsc{\DIFadd{CMB-BEst}} \DIFadd{has a single set of mode functions while Modal requires two; one in each of the primordial and late-time space (see section \ref{section:CMB_bispectrum_estimators}). While the Modal approach can accurately express a wide range of bispectra }\cite{Fergusson2012,Fergusson2014,PlanckCollaboration2013}\DIFadd{, the two-step modal expansion becomes less accurate for highly oscillatory shapes since the oscillations often get lost during the projection to late-time space }\cite{Fergusson2015a,PlanckCollaboration2018}\DIFadd{. }\textsc{\DIFadd{CMB-BEst}} \DIFadd{avoids these issues in the second mode expansion by evaluating an exact analytical form analogous to the KSW estimator }\cite{Komatsu2005}\DIFadd{. The results obtained from }\textsc{\DIFadd{CMB-BEst}} \DIFadd{is therefore as accurate as the primordial basis expansion.
}
