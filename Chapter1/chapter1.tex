...
Note that the 4-velocity must follow the geodesic equation (\ref{eqn:geodesic}), and divergence of the energy-momentum tensor vanishes for a perfect fluid;
\begin{align}
	\nabla_\nu T^{\mu\nu} =& (\rho + P) \nabla_\nu \left( U^\mu U^\nu \right) + P \nabla_\mu g^{\mu\nu} \\
	=& 
\end{align}

TODO: dervie conservation equation. Explain cosmic inventory table.

The universe consists of many different particles, but they can be broadly categorised into three: radiation, matter, and dark energy. Here, we assume that they are perfect fluids with a constant equation fo state; $P = \omega \rho$. 
...
Define conformal time, growth of the universe. Define redshift.
