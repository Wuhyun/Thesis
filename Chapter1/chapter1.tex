...
Chapters 1 and 2 are purely introductory and contain textbook materials for cosmology based on \cite{Dodelson2003textbook,Fergusson2020cosmology,Challinor2009lecture,Baumann2018primordialNotes,Lim2012advancedCosmo}. Chapter 3 consists of literature reviews on the topic with references in the text. All written codes and plots in Chapters 4 and 5 are results of my own work unless explicitly specified otherwise.
