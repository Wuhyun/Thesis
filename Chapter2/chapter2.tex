...
The early universe was quite hot. It was too hot for neutral hydrogens to form, and even when the temperature of the universe dropped below the binding energy $13.6$eV ($\approx 158,000$K), overwhelming photon number density meant that any hydrogen atoms produced are ionised instantly. The universe then consisted of opaque plasma where photons are tightly coupled to electrons via Compton scattering. Only when the temperature dropped down to $\approx 3000$K roughly 370,000 years after the Big Bang, at \textit{recombination}, it was finally cold enough for electrons to combine with protons and form hydrogen atom, rendering the universe transparent all of a sudden. Photons began streaming freely away from the surface they last scattered at redshift $\approx 1100$ until observed by us today as the Cosmic Microwave Background (CMB).

The CMB follows a blackbody spectrum with temperature $T_{CMB}=2.725$K, a fit so exquisite that the error bars are completely hidden within the theoretical curve in most plots. Looking closer into the map of CMB temperature there are fluctuations of order $10^{-5}$ which closely relates to the primordial perturbations and subsequent evolution history. Satellite surveys such as COBE, WMAP and Planck, as well as ground-based experiments including ACT, SPT, and BICEP produced precise measurements of the CMB which have been thoroughly studied since. (TODO: add references) The CMB anisotropy is a gold standard dataset for precision cosmology.
